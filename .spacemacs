...
values."
  (setq-default
   ...
   ;; If non-nil then Spacemacs wiac-helm
ac-ispell
ac-python
ace-flyspell
ace-jump-helm-line
...
zencoding-mode
zonokai-theme
ll ask for confirmation before installing
