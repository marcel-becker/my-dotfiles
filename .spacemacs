...
you should place your code here."
  ...
  (message  (concat "Loading user config from " load-file-name))
  ...
  ;; add everything under ~/.spacemacs.d to it
  ...
  (message  (concat "Loading user config  " (concat user-emacs-directory "private/marcel/config.el")))
  (setq user-emacs-directory marcel-lisp-dir)
  (load (concat user-emacs-directory "private/marcel/config.el"))
